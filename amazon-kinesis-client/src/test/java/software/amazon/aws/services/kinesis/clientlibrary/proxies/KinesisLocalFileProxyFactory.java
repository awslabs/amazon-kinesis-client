 ...
 */
package software.amazon.aws.services.kinesis.clientlibrary.proxies;
...
public class KinesisLocalFileProxyFactory implements IKinesisProxyFactory {
    ...
    /* (non-Javadoc)
     * @see software.amazon.aws.services.kinesis.clientlibrary.proxies.IKinesisProxyFactory#getProxy(java.lang.String)
     */
    @Override
