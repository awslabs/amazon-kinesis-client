...
public class Worker implements Runnable {
    ...
    @Deprecated
    public Worker(
            software.amazon.aws.services.kinesis.clientlibrary.interfaces.IRecordProcessorFactory recordProcessorFactory,
    ...
    public static class Builder {
        ...
        /**
         * Provide a V1 {@link software.amazon.aws.services.kinesis.clientlibrary.interfaces.IRecordProcessor
         * IRecordProcessor}.
         *
         * @param recordProcessorFactory
         *            Used to get record processor instances for processing data from shards
