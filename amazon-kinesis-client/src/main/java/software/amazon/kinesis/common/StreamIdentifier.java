...
public class StreamIdentifier {
    ...
    @Builder.Default
    @EqualsAndHashCode.Exclude
    private final StreamType streamType = StreamType.KINESIS;
    ...
    public static StreamIdentifier multiStreamInstance(String streamIdentifierSer) {
        return multiStreamInstance(streamIdentifierSer, StreamType.KINESIS);
    }
     ...
     * @return StreamIdentifier with {@link #accountIdOptional} and {@link #streamCreationEpochOptional} present
     */
    public static StreamIdentifier multiStreamInstance(String streamIdentifierSer, StreamType streamType) {
    ...
    public static StreamIdentifier singleStreamInstance(String streamName) {
        return singleStreamInstance(streamName, StreamType.KINESIS);
    }
     ...
     * @param streamType the type of stream
     */
    public static StreamIdentifier singleStreamInstance(String streamName, StreamType streamType) {
